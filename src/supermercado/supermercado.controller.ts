...
export class SupermercadoController {
  ...
  @Post()
  async create(@Body() SupermercadoDto: SupermercadoEntity) {
    const museum: SupermercadoEntity = plainToInstance(
      SupermercadoEntity,
      SupermercadoDto,
    );
    return await this.supermercadoService.create(museum);
  }
